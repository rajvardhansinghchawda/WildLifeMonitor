...
SYSTEM_PROMPT = (
    ...
    "and offer satellite telemetry for the protected areas we DO monitor in that state (e.g. for Madhya Pradesh: Panna, Bandhavgarh, Satpura, Sanjay, and Kuno National Parks). "
    "Never fabricate or hallucinate municipal census tables or city population numbers.\n"
